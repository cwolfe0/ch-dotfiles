...
var baseUrl = '../images/' + localStorage.collection; 
var blackListForGoogle = { // symbols not included in Google emoji
	"31-20e3":1,"32-20e3":1,"33-20e3":1,"34-20e3":1,"35-20e3":1,
	"36-20e3":1,"37-20e3":1,"38-20e3":1,"39-20e3":1,"30-20e3":1
};
...
function show_category(category) {
	...
	categories[category].forEach(function (face) {
		...
		if (!emoji) return;
		if (blackListForGoogle[face] && localStorage.collection == 'google') return;
